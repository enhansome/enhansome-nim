...
* [Nim](https://github.com/nim-lang/Nim) ⭐ 18,169 | 🐛 2,182 | 🌐 Nim | 📅 2026-08-12 - Nim (formerly known as "Nimrod") is a compiled, garbage-collected systems programming language which has an excellent productivity/performance ratio. Nim's design focuses on efficiency, expressiveness, elegance (in the order of priority).
* [nlvm](https://github.com/arnetheduck/nlvm) ⭐ 775 | 🐛 14 | 🌐 Nim | 📅 2026-07-26 - LLVM backend for Nim.
...
* [pylib](https://github.com/nimpylib/pylib) ⭐ 76 | 🐛 11 | 🌐 Nim | 📅 2026-07-04 - Pure Nim implementation for Python builtins, libraries and sugars.

### Package Repositories

* [Nim packages](https://github.com/nim-lang/packages) ⭐ 500 | 🐛 17 | 🌐 Nim | 📅 2026-08-12 - List of packages for Nimble.
* [Nim package directory](https://nimble.directory/) - Explore Nim packages known to Nimble.

### Editors

* [moe](https://github.com/fox0430/moe) ⭐ 721 | 🐛 44 | 🌐 Nim | 📅 2026-08-12 - A vim-like editor made with Nim, also supports C, Rust, Javascript, etc.
* [Nev](https://github.com/Nimaoth/Nev) ⭐ 200 | 🐛 7 | 🌐 Nim | 📅 2026-07-06 - A keyboard focused GUI and terminal text editor.
...
* [chronos](https://github.com/status-im/nim-chronos) ⭐ 412 | 🐛 62 | 🌐 Nim | 📅 2026-08-12 - An efficient library for asynchronous programming.
...
* [taskpools](https://github.com/status-im/nim-taskpools) ⭐ 122 | 🐛 11 | 🌐 Nim | 📅 2026-08-10 - Lightweight, energy-efficient, easily auditable threadpools.
...
* [result](https://github.com/arnetheduck/nim-result/) ⭐ 176 | 🐛 14 | 🌐 Nim | 📅 2026-07-21 - Friendly, exception-free value-or-error returns, similar to Option\[T].
...
* [traitor](https://github.com/beef331/traitor) ⭐ 34 | 🐛 0 | 🌐 Nim | 📅 2026-01-18 - A macro heavy trait library made from boredom.
* [classy](https://github.com/nigredo-tori/classy) ⚠️ Archived - Haskell-style typeclasses for Nim.

### Functional Programming

* [zero-functional](https://github.com/zero-functional/zero-functional) ⭐ 342 | 🐛 3 | 🌐 C++ | 📅 2022-09-19 - A library providing (almost) zero-cost chaining for functional abstractions in Nim.
...
* [pipe](https://github.com/5paceToast/pipe) ⭐ 67 | 🐛 2 | 🌐 Nim | 📅 2021-07-26 - Pipe operator for Nim, as seen in functional languages.
* [nim-pipexp](https://github.com/ShalokShalom/nim-pipexp) ⭐ 6 | 🐛 0 | 🌐 Nim | 📅 2022-12-10 - Expression-based pipe operators with placeholder argument for Nim.
...
* [regex](https://github.com/nitely/nim-regex) ⭐ 246 | 🐛 18 | 🌐 Nim | 📅 2026-04-13 - Pure Nim regex engine with linear time match.
...
* [gara](https://github.com/alehander42/gara) ⭐ 105 | 🐛 13 | 🌐 Nim | 📅 2020-06-16 - Macro-based pattern matching library.
...
* [with](https://github.com/zevv/with) ⭐ 90 | 🐛 2 | 🌐 Nim | 📅 2023-01-29 - The `with` macro for Nim.
...
* [winim](https://github.com/khchen/winim) ⭐ 516 | 🐛 22 | 🌐 Nim | 📅 2024-07-19 - Nim's Windows API and COM Library.
...
* [faststreams](https://github.com/status-im/nim-faststreams) ⭐ 133 | 🐛 1 | 🌐 Nim | 📅 2026-08-04 - Nearly zero-overhead input/output streams for Nim.
* [lockfreequeues](https://github.com/elijahr/lockfreequeues) ⭐ 50 | 🐛 3 | 🌐 Nim | 📅 2026-08-12 - Lock-free queue implementations for Nim.
...
* [daemon](https://github.com/status-im/nim-daemon) ⭐ 36 | 🐛 1 | 🌐 Nim | 📅 2019-01-08 - Cross-platform process daemonization library for the Nim language.
...
* [nimcr](https://github.com/PMunch/nimcr) ⭐ 88 | 🐛 4 | 🌐 Nim | 📅 2021-08-09 - Running Nim code with Shebangs.
* [nimr](https://github.com/Jeff-Ciesielski/nimr) ⭐ 47 | 🐛 1 | 🌐 Nim | 📅 2020-07-28 - Run Nim programs like scripts.
* [nimbang](https://github.com/jabbalaci/nimbang) ⭐ 6 | 🐛 1 | 🌐 Nim | 📅 2026-03-29 - Running Nim programs as scripts with shebang.
...
* [node-exporter-lite](https://github.com/twekkel/node_exporter-lite) ⭐ 1 | 🐛 0 | 🌐 Nim | 📅 2026-05-22 - An ultra‑light [node\_exporter](https://github.com/prometheus/node_exporter) ⭐ 13,694 | 🐛 322 | 🌐 Go | 📅 2026-08-08 replacement.
* [unbound-exporter-lite](https://github.com/twekkel/unbound_exporter-lite) ⭐ 1 | 🐛 0 | 🌐 Nim | 📅 2026-05-22 - An ultra‑light [unbound\_exporter](https://github.com/letsencrypt/unbound_exporter) ⭐ 273 | 🐛 18 | 🌐 Go | 📅 2026-06-04 replacement.
...
* [Nesper](https://github.com/elcritch/nesper) ⭐ 245 | 🐛 7 | 🌐 C | 📅 2026-01-10 - Program the ESP32 using Nim. Library on top of esp-idf.
* [ratel](https://github.com/PMunch/ratel) ⭐ 132 | 🐛 4 | 🌐 Nim | 📅 2022-10-16 - Next-generation, zero-cost abstraction microconroller programming in Nim.
...
* [qex](https://github.com/jcosborn/qex) ⭐ 60 | 🐛 3 | 🌐 Nim | 📅 2026-08-10 - High-level framework for lattice field operations.
* [orbits](https://github.com/treeform/orbits) ⭐ 56 | 🐛 0 | 🌐 Nim | 📅 2026-05-25 - Orbital mechanics library for Nim.
...
* [redis](https://github.com/nim-lang/redis) ⭐ 132 | 🐛 11 | 🌐 Nim | 📅 2026-08-11 - Official redis wrapper for Nim.
...
* [SQLiteral](https://github.com/olliNiinivaara/SQLiteral) ⭐ 60 | 🐛 0 | 🌐 Nim | 📅 2026-07-31 - A high level SQLite API for Nim.
* [limdb](https://github.com/capocasa/limdb) ⭐ 46 | 🐛 4 | 🌐 Nim | 📅 2026-02-11 - Very high performance, persistent and safe key-value store based on LMDB with Nim table-like interface.
* [anonimongo](https://github.com/mashingan/anonimongo) ⭐ 44 | 🐛 11 | 🌐 Nim | 📅 2026-06-20 - Another Nim pure Mongo DB driver.
* [rocksdb](https://github.com/status-im/nim-rocksdb) ⭐ 41 | 🐛 3 | 🌐 Nim | 📅 2026-07-07 - Nim wrapper for RocksDB, a persistent key-value store for flash and RAM Storage.
...
* [KoutenDB](https://github.com/puffball1567/koutendb) ⭐ 15 | 🐛 0 | 🌐 Nim | 📅 2026-08-10 - Locality-aware NoSQL document/vector database built around rings and orbit-inspired retrieval.
* [surrealdb.nim](https://github.com/Xkonti/surrealdb.nim) ⭐ 13 | 🐛 2 | 🌐 Nim | 📅 2025-11-21 - SurrealDB driver for Nim.
...
* [kuzu](https://github.com/mahlonsmith/nim-kuzu) ⭐ 1 | 🐛 0 | 🌐 Nim | 📅 2026-07-21 - Wrapper for Kuzu - an embedded graph database built for query speed and scalability.

#### ORM

* [norm](https://github.com/moigagoo/norm) ⭐ 415 | 🐛 18 | 🌐 Nim | 📅 2026-08-05 - Norm is an object-oriented, framework-agnostic ORM for Nim that supports SQLite and PostgreSQL.
* [ormin](https://github.com/Araq/ormin) ⭐ 196 | 🐛 10 | 🌐 Nim | 📅 2026-04-29 - Prepared SQL statement generator , A lightweight ORM.
...
* [mpfit](https://github.com/Vindaar/nim-mpfit) ⭐ 19 | 🐛 1 | 🌐 C | 📅 2025-03-18 - A wrapper for the cMPFIT library for Nim.
...
* [parsetoml](https://github.com/NimParsers/parsetoml) ⭐ 129 | 🐛 10 | 🌐 Nim | 📅 2025-01-12 - A Nim library to parse TOML files.
...
* [Marvdown](https://github.com/openpeeps/marvdown) ⭐ 10 | 🐛 0 | 🌐 Nim | 📅 2026-08-12 - A stupid simple Markdown parser.
...
* [flatty](https://github.com/treeform/flatty) ⭐ 95 | 🐛 1 | 🌐 Nim | 📅 2026-07-14 - Tools and serializer for plain flat binary files.
* [serialization](https://github.com/status-im/nim-serialization) ⭐ 80 | 🐛 12 | 🌐 Nim | 📅 2026-07-21 - A modern and extensible serialization framework for Nim.
* [json-serialization](https://github.com/status-im/nim-json-serialization) ⭐ 55 | 🐛 7 | 🌐 Nim | 📅 2026-08-06 - Flexible JSON serialization not relying on run-time type information.
* [frosty](https://github.com/disruptek/frosty) ⭐ 50 | 🐛 1 | 🌐 Nim | 📅 2021-11-12 - Marshal native Nim objects via streams, sockets.
* [toml-serialization](https://github.com/status-im/nim-toml-serialization) ⭐ 46 | 🐛 4 | 🌐 Nim | 📅 2026-07-02 - Flexible TOML serialization `not` relying on run-time type information.
* [protobuf-serialization](https://github.com/status-im/nim-protobuf-serialization) ⭐ 27 | 🐛 8 | 🌐 Nim | 📅 2026-08-07 - The nim-protobuf-serialization.
* [bingo](https://github.com/planetis-m/bingo) ⭐ 20 | 🐛 5 | 🌐 Nim | 📅 2024-04-05 - Binary serialization framework for Nim.
* [ssz-serialization](https://github.com/status-im/nim-ssz-serialization) ⭐ 11 | 🐛 4 | 🌐 Nim | 📅 2026-08-12 - Nim implementation of Simple Serialize (SSZ) serialization and merkleization.
...
* [markdown](https://github.com/soasme/nim-markdown) ⭐ 156 | 🐛 16 | 🌐 Nim | 📅 2025-12-09 - A beautiful Markdown Parser in the Nim world.
...
* [omni](https://github.com/vitreo12/omni) ⭐ 203 | 🐛 58 | 🌐 Nim | 📅 2024-03-29 - A DSL for low-level audio programming.
* [paramidi](https://github.com/paranim/paramidi) ⭐ 77 | 🐛 2 | 🌐 Nim | 📅 2023-03-16 - A Nim library for making MIDI music.
...
* [pixie](https://github.com/treeform/pixie) ⭐ 807 | 🐛 18 | 🌐 Nim | 📅 2026-07-15 - A full-featured 2D graphics library for Nim.
...
* [neo](https://github.com/unicredit/neo) ⭐ 257 | 🐛 19 | 🌐 HTML | 📅 2024-08-28 - A matrix library.
* [manu](https://github.com/planetis-m/manu) ⚠️ Archived - Nim MAtrix NUmeric package - a port of JAMA, adapted to Nim.
* [nlopt](https://github.com/Vindaar/nimnlopt) ⭐ 14 | 🐛 1 | 🌐 Nim | 📅 2022-02-08 - A wrapper for the nonlinear optimization library Nlopt.
...
* [bigints](https://github.com/nim-lang/bigints) ⭐ 130 | 🐛 28 | 🌐 Nim | 📅 2025-11-24 - Bigints for Nim.
* [stint](https://github.com/status-im/nim-stint) ⭐ 93 | 🐛 17 | 🌐 Nim | 📅 2026-07-27 - Stack-based arbitrary-precision integers. Fast and portable with natural syntax for resource-restricted devices.
* [theo](https://github.com/SciNim/theo) ⭐ 27 | 🐛 2 | 🌐 Nim | 📅 2022-03-02 - An optimized bigint and number theory library for Nim.

### Cryptography

* [constantine](https://github.com/mratsim/constantine) ⭐ 496 | 🐛 94 | 🌐 Nim | 📅 2026-08-04 - Constant time pairing-based of elliptic curve based cryptography and digital signatures.
* [nimcrypto](https://github.com/cheatfate/nimcrypto) ⭐ 219 | 🐛 12 | 🌐 Nim | 📅 2026-07-06 - Nim cryptographic library.
...
* [bslcurve](https://github.com/status-im/nim-blscurve) ⭐ 27 | 🐛 5 | 🌐 Nim | 📅 2026-07-28 - Nim implementation of BLS signature scheme (Boneh-Lynn-Shacham) over Barreto-Lynn-Scott (BLS) curve BLS12-381.
...
* [nimbus-eth2](https://github.com/status-im/nimbus-eth2) ⭐ 660 | 🐛 224 | 🌐 Nim | 📅 2026-08-12 - Efficient implementation of the Ethereum 2.0 blockchain.
* [nimbus-eth1](https://github.com/status-im/nimbus-eth1) ⭐ 625 | 🐛 114 | 🌐 Nim | 📅 2026-08-13 - An Ethereum 1.0 and 2.0 client for resource-restricted devices.
* [eth](https://github.com/status-im/nim-eth) ⭐ 93 | 🐛 45 | 🌐 Nim | 📅 2026-08-06 - Common utilities for Ethereum.
...
* [zippy](https://github.com/guzba/zippy) ⭐ 282 | 🐛 21 | 🌐 Nim | 📅 2026-05-01 - Pure Nim implementation of deflate, zlib, gzip and zip.
...
* [snappy](https://github.com/status-im/nim-snappy) ⭐ 28 | 🐛 4 | 🌐 Nim | 📅 2026-08-03 - Nim implementation of Snappy compression algorithm.

## User Interface

### Terminal

* [illwill](https://github.com/johnnovak/illwill) ⭐ 467 | 🐛 5 | 🌐 Nim | 📅 2026-05-15 - Simple cross-platform terminal library inspired by (n)curses.
* [jn](https://github.com/joereynolds/jn) ⭐ 64 | 🐛 39 | 🌐 Nim | 📅 2026-08-01 - A CLI note taker and task manager.
* [Nimmm](https://github.com/joachimschmidt557/nimmm) ⭐ 51 | 🐛 1 | 🌐 Nim | 📅 2026-05-30 - A terminal file manager for Linux.
* [niffler](https://github.com/gokr/niffler) ⭐ 31 | 🐛 1 | 🌐 Nim | 📅 2026-04-08 - Command line AI assistant written in Nim.
* [pnimrp](https://github.com/bloomingchad/pnimrp) ⭐ 5 | 🐛 2 | 🌐 Nim | 📅 2026-08-11 - Stream your favorite radio stations at the comfort of your terminal.
...
* [typography](https://github.com/treeform/typography) ⭐ 150 | 🐛 2 | 🌐 Nim | 📅 2022-08-21 - Fonts, typesetting and rasterization.
* [chroma](https://github.com/treeform/chroma) ⭐ 108 | 🐛 1 | 🌐 Nim | 📅 2026-05-25 - Everything you want to do with colors, in Nim.
* [trick](https://github.com/exelotl/trick) ⭐ 31 | 🐛 2 | 🌐 Nim | 📅 2026-05-16 - Library for GBA/NDS image conversion, and more!
...
* [uing](https://github.com/neroist/uing) ⭐ 194 | 🐛 2 | 🌐 Nim | 📅 2026-07-08 - Wrapper & bindings for libui-ng, an updated and maintained fork of libui.
...
* [wNim](https://github.com/khchen/wNim) ⭐ 353 | 🐛 34 | 🌐 Nim | 📅 2024-07-19 - Nim's Windows GUI Framework.
...
* [nimqml](https://github.com/filcuc/nimqml) ⭐ 177 | 🐛 6 | 🌐 Nim | 📅 2025-02-05 - Qt QML bindings for the Nim programming language.

#### Web Technology

* [Neel](https://github.com/Niminem/Neel) ⭐ 251 | 🐛 1 | 🌐 Nim | 📅 2023-11-30 - A library for making Electron-like HTML/JS GUI apps.
* [webui](https://github.com/webui-dev/nim-webui) ⭐ 163 | 🐛 10 | 🌐 HTML | 📅 2026-03-24 - Nim bindings and wrapper for WebUI.
* [nimview](https://github.com/marcomq/nimview) ⭐ 161 | 🐛 8 | 🌐 Nim | 📅 2022-09-18 - A Nim/Webview based helper to create desktop/server applications with Nim and HTML/CSS.
* [webgui](https://github.com/juancarlospaco/webgui) ⭐ 145 | 🐛 4 | 🌐 Nim | 📅 2026-05-29 - Web technologies based cross-platform GUI Framework with a dark theme.
* [webview](https://github.com/neroist/webview) ⭐ 49 | 🐛 3 | 🌐 Nim | 📅 2026-05-03 - Nim bindings and wrapper for Webview.
* [fidget2](https://github.com/treeform/fidget2) ⭐ 38 | 🐛 4 | 🌐 Nim | 📅 2025-12-16 - Library for natively compiled cross platform UIs - Web with HTML5 (WASM), Windows, macOS, Linux with OpenGL.

#### Lightweight

* [imgui](https://github.com/nimgl/imgui) ⭐ 150 | 🐛 4 | 🌐 C++ | 📅 2025-12-20 - ImGui bindings for Nim via cimgui.
...
* [libp2p](https://github.com/status-im/nim-libp2p) ⭐ 318 | 🐛 107 | 🌐 Nim | 📅 2026-08-13 - A Nim implementation of the libp2p networking stack.
* [puppy](https://github.com/treeform/puppy) ⭐ 206 | 🐛 12 | 🌐 Nim | 📅 2026-05-25 - Puppy fetches HTML pages for Nim.
* [netty](https://github.com/treeform/netty) ⭐ 129 | 🐛 0 | 🌐 Nim | 📅 2026-07-14 - Reliable UDP connection library for games in Nim.
* [json-rpc](https://github.com/status-im/nim-json-rpc) ⭐ 101 | 🐛 10 | 🌐 Nim | 📅 2026-08-08 - Nim library for implementing JSON-RPC clients and servers.
* [presto](https://github.com/status-im/nim-presto) ⭐ 84 | 🐛 9 | 🌐 Nim | 📅 2026-08-07 - An efficient REST API framework.
* [nmqtt](https://github.com/zevv/nmqtt) ⭐ 53 | 🐛 9 | 🌐 Nim | 📅 2026-03-30 - Native Nim MQTT client library.
* [yahttp](https://github.com/mishankov/yahttp) ⭐ 30 | 🐛 7 | 🌐 Nim | 📅 2026-07-01 - Awesome simple HTTP client.
* [http-utils](https://github.com/status-im/nim-http-utils) ⭐ 28 | 🐛 2 | 🌐 Nim | 📅 2026-07-21 - HTTP helper procedures.
...
* [websock](https://github.com/status-im/nim-websock) ⭐ 93 | 🐛 17 | 🌐 Nim | 📅 2026-08-06 - An implementation of the WebSocket protocol for Nim.
...
* [nwaku](https://github.com/status-im/nwaku) ⭐ 248 | 🐛 245 | 🌐 Nim | 📅 2026-08-12 - Implementation of the Waku v1 and v2 protocols.
* [dimscord](https://github.com/krisppurg/dimscord) ⭐ 240 | 🐛 4 | 🌐 Nim | 📅 2026-06-21 - A Discord Bot & REST Library for Nim.
* [telebot.nim](https://github.com/ba0f3/telebot.nim) ⭐ 193 | 🐛 0 | 🌐 Nim | 📅 2026-02-22 - Async client for Telegram Bot API in pure Nim.
...
* [httpx](https://github.com/ringabout/httpx) ⭐ 99 | 🐛 12 | 🌐 Nim | 📅 2024-11-26 - Cross platform web server for Nim. A fork of httpbeast adding Windows support.
* [GuildenStern](https://github.com/olliNiinivaara/GuildenStern) ⭐ 99 | 🐛 0 | 🌐 Nim | 📅 2026-07-26 - Genuinely multithreading integrated HTTP/1.1 + WebSocket v13 Server for POSIX-compliant OSes.
...
* [Jester](https://github.com/dom96/jester) ⭐ 1,626 | 🐛 67 | 🌐 Nim | 📅 2026-07-29 - The sinatra-like web framework for Nim. Jester provides a DSL for quickly creating web applications in Nim.
* [prologue](https://github.com/planety/prologue) ⭐ 1,347 | 🐛 45 | 🌐 Nim | 📅 2026-07-21 - A fullstack web framework written in Nim.
* [karax](https://github.com/karaxnim/karax) ⭐ 1,168 | 🐛 15 | 🌐 Nim | 📅 2026-07-12 - A framework for developing single page applications in Nim.
...
* [basolato](https://github.com/itsumura-h/nim-basolato) ⭐ 250 | 🐛 16 | 🌐 Nim | 📅 2026-05-08 - A fullstack web framework for Nim based on Jester.
...
* [Jazzy](https://github.com/canermastan/jazzy-framework) ⭐ 54 | 🐛 3 | 🌐 Nim | 📅 2026-07-28 - The Productive Framework. Developer-friendly, lightning fast, and designed for rapid development.
* [Supranim](https://github.com/supranim/supranim) ⭐ 40 | 🐛 1 | 🌐 Nim | 📅 2026-08-07 - A simple web framework for creating REST APIs and beautiful web apps. Model View Controller structure and other cool things.
...
* [templates](https://github.com/onionhammer/nim-templates) ⭐ 98 | 🐛 2 | 🌐 Nim | 📅 2019-10-20 - A simple string templating library for Nim.
* [mustache](https://github.com/soasme/nim-mustache) ⭐ 74 | 🐛 2 | 🌐 Nim | 📅 2023-03-19 - A full implementation of v1.2.1 of the Mustache spec.
* [html-dsl](https://github.com/juancarlospaco/nim-html-dsl) ⭐ 68 | 🐛 0 | 🌐 Nim | 📅 2020-04-14 - Nim HTML DSL.
* [Tim](https://github.com/openpeeps/tim) ⭐ 66 | 🐛 7 | 🌐 Nim | 📅 2026-08-06 - A high-performance template engine & markup language.
...
* [GLAD](https://github.com/Dav1dde/glad) ⭐ 4,574 | 🐛 32 | 🌐 C | 📅 2026-06-18 - Multi-Language Vulkan/GL/GLES/EGL/GLX/WGL Loader-Generator based on the official specs.
* [enu](https://github.com/dsrw/enu) ⭐ 483 | 🐛 19 | 🌐 Nim | 📅 2026-07-28 - 3D live coding with a Logo-like DSL for Godot, implemented in Nim.
* [nimgl](https://github.com/nimgl/nimgl) ⭐ 410 | 🐛 23 | 🌐 Nim | 📅 2024-07-15 - NimGL is a Nim library that offers bindings for popular libraries used in computer graphics.
* [glm](https://github.com/stavenko/nim-glm) ⭐ 101 | 🐛 3 | 🌐 Nim | 📅 2026-05-18 - Port of the popular glm C++ library to Nim.

### Game Frameworks

* [nico](https://github.com/ftsf/nico) ⭐ 665 | 🐛 23 | 🌐 Nim | 📅 2024-07-09 - Nim Game Framework based on Pico-8.
* [naylib](https://github.com/planetis-m/naylib) ⚠️ Archived - safe Raylib wrapper.
* [natu](https://github.com/exelotl/natu) ⭐ 249 | 🐛 0 | 🌐 Nim | 📅 2025-02-15 - Toolkit for writing Game Boy Advance games in Nim.
...
* [godot-nim](https://github.com/pragmagic/godot-nim) ⭐ 507 | 🐛 32 | 🌐 Nim | 📅 2022-12-17 - Nim bindings for Godot Engine.
* [nimgame2](https://github.com/Vladar4/nimgame2) ⭐ 181 | 🐛 7 | 🌐 Nim | 📅 2025-09-11 - A simple 2D game engine for Nim.
* [rod](https://github.com/yglukhov/rod) ⭐ 141 | 🐛 10 | 🌐 Nim | 📅 2026-02-05 - Cross-platform 2D and 3D game engine.
...
* [norx](https://github.com/tankfeud/norx) ⭐ 21 | 🐛 1 | 🌐 Nim | 📅 2025-11-10 - A complete wrapper of the ORX 2.5D cross platform game engine library.
...
* [Editor Support](https://github.com/nim-lang/Nim/wiki/editor-support) ⭐ 18,169 | 🐛 2,182 | 🌐 Nim | 📅 2026-08-12 - Official list of editor plugins for Nim.
* [nimlsp](https://github.com/PMunch/nimlsp) ⭐ 446 | 🐛 45 | 🌐 Nim | 📅 2026-02-09 - The Language Server Protocol implementation for Nim.
* [nim.nvim](https://github.com/alaviss/nim.nvim) ⭐ 216 | 🐛 15 | 🌐 Vim Script | 📅 2025-04-12 - Nim plugin for NeoVim.
* [vscode-nim](https://github.com/saem/vscode-nim) ⭐ 174 | 🐛 56 | 🌐 Nim | 📅 2026-08-11 - Language support for the Nim programming language for VS Code.

### REPL

* [INim](https://github.com/AndreiRegiani/INim) ⭐ 683 | 🐛 28 | 🌐 Nim | 📅 2026-02-08 - Interactive Nim Shell.
* [jupyternim](https://github.com/stisa/jupyternim) ⭐ 170 | 🐛 5 | 🌐 Nim | 📅 2022-12-30 - A Jupyter kernel for Nim.
* [Reploid](https://github.com/RowDaBoat/reploid) ⭐ 10 | 🐛 0 | 🌐 Nim | 📅 2026-01-21 - A Nim REPL running on top of a `nim c` or a `nimscript` VM, `import [anything]`.

### Binding Generators

* [nimpy](https://github.com/yglukhov/nimpy) ⭐ 1,591 | 🐛 34 | 🌐 Nim | 📅 2026-06-27 - Generate Python wrappers and call Python from Nim.
* [c2nim](https://github.com/nim-lang/c2nim) ⭐ 527 | 🐛 42 | 🌐 Nim | 📅 2026-05-15 - c2nim is a tool to translate Ansi C code to Nim.
* [Futhark](https://github.com/PMunch/futhark) ⭐ 505 | 🐛 47 | 🌐 Nim | 📅 2026-07-06 - Automatic wrapping of C headers in Nim with libclang.
* [nimterop](https://github.com/nimterop/nimterop) ⭐ 375 | 🐛 62 | 🌐 Nim | 📅 2023-04-03 - A Nim package that leverages tree-sitter to make C/C++ interop seamless. Superseded by Futhark.
* [jnim](https://github.com/yglukhov/jnim) ⭐ 214 | 🐛 0 | 🌐 Nim | 📅 2025-08-19 - Nim - Java bridge.
* [nimgen](https://github.com/genotrance/nimgen) ⭐ 115 | 🐛 9 | 🌐 C | 📅 2021-09-01 - nimgen is a helper for c2nim to simplify and automate the wrapping of C libraries. Superseded by nimterop.

<!-- - [rnim](https://github.com/SciNim/rnim) - A bridge between R and Nim. Currently this is a barely working prototype. -->

### Build Systems / Package Management

* [Nimble](https://github.com/nim-lang/nimble) ⭐ 1,399 | 🐛 256 | 🌐 Nim | 📅 2026-08-12 - Nimble can be used as a build system.
...
* [Atlas](https://github.com/nim-lang/atlas) ⭐ 149 | 🐛 9 | 🌐 Nim | 📅 2026-08-03 - The Atlas Package cloner. It manages an isolated workspace that contains projects and dependencies.
...
* [nimby](https://github.com/treeform/nimby) ⭐ 44 | 🐛 3 | 🌐 Nim | 📅 2026-08-13 - A very simple and unofficial package manager for Nim.
...
* [chronicles](https://github.com/status-im/nim-chronicles) ⭐ 176 | 🐛 17 | 🌐 Nim | 📅 2026-07-23 - A crafty implementation of structured logging for Nim.
* [kslog](https://github.com/c-blake/kslog) ⭐ 13 | 🐛 0 | 🌐 Nim | 📅 2026-06-18 - Minimalistic Kernel-Syslogd For Linux in Nim.
* [threadlogging](https://codeberg.org/pswilde/threadlogging) - A thread safe logging library using Nim's own logging module.

### Testing

* [balls](https://github.com/disruptek/balls) ⭐ 69 | 🐛 9 | 🌐 Nim | 📅 2026-02-16 - A unittest macro to save the world, or at least your Sunday.
...
* [unittest2](https://github.com/status-im/nim-unittest2) ⭐ 31 | 🐛 12 | 🌐 Nim | 📅 2026-05-12 - Fork of the "unittest" Nim module focusing on parallel test execution, test-level scoping and strict exception handling.
...
* [cligen](https://github.com/c-blake/cligen) ⭐ 581 | 🐛 0 | 🌐 Nim | 📅 2026-07-21 - Infer & generate command-line interace/option/argument parsers.
* [docopt.nim](https://github.com/docopt/docopt.nim) ⭐ 215 | 🐛 6 | 🌐 Nim | 📅 2023-09-18 - Command-line args parser.
* [argparse](https://github.com/iffy/nim-argparse) ⭐ 129 | 🐛 12 | 🌐 Nim | 📅 2024-08-16 - Argument parsing for Nim.
* [cliche](https://github.com/juancarlospaco/cliche) ⭐ 85 | 🐛 2 | 🌐 Nim | 📅 2026-04-19 - AutoMagic CLI argument parsing is so cliché.
* [confutils](https://github.com/status-im/nim-confutils) ⭐ 69 | 🐛 16 | 🌐 Nim | 📅 2026-07-14 - Simplified handling of command line options and config files
...
* [Nim for Python programmers](https://github.com/nim-lang/Nim/wiki/Nim-for-Python-Programmers) ⭐ 18,169 | 🐛 2,182 | 🌐 Nim | 📅 2026-08-12 - Guide to Nim for people with experience in Python.
