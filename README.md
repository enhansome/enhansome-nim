...
* [Nim](https://github.com/nim-lang/Nim) ⭐ 18,231 | 🐛 2,189 | 🌐 Nim | 📅 2026-09-11 - Nim (formerly known as "Nimrod") is a compiled, garbage-collected systems programming language which has an excellent productivity/performance ratio. Nim's design focuses on efficiency, expressiveness, elegance (in the order of priority).
* [nlvm](https://github.com/arnetheduck/nlvm) ⭐ 775 | 🐛 12 | 🌐 Nim | 📅 2026-09-11 - LLVM backend for Nim.
...
* [Nim packages](https://github.com/nim-lang/packages) ⭐ 500 | 🐛 19 | 🌐 Nim | 📅 2026-09-10 - List of packages for Nimble.
* [Nim package directory](https://nimble.directory/) - Explore Nim packages known to Nimble.

### Editors

* [moe](https://github.com/fox0430/moe) ⭐ 722 | 🐛 45 | 🌐 Nim | 📅 2026-09-10 - A vim-like editor made with Nim, also supports C, Rust, Javascript, etc.
...
* [taskpools](https://github.com/status-im/nim-taskpools) ⭐ 123 | 🐛 7 | 🌐 Nim | 📅 2026-09-05 - Lightweight, energy-efficient, easily auditable threadpools.
...
* [lockfreequeues](https://github.com/elijahr/lockfreequeues) ⭐ 50 | 🐛 3 | 🌐 Nim | 📅 2026-09-11 - Lock-free queue implementations for Nim.
...
* [node-exporter-lite](https://github.com/twekkel/node_exporter-lite) ⭐ 2 | 🐛 0 | 🌐 Nim | 📅 2026-05-22 - An ultra‑light [node\_exporter](https://github.com/prometheus/node_exporter) ⭐ 13,778 | 🐛 312 | 🌐 Go | 📅 2026-09-03 replacement.
...
* [qex](https://github.com/jcosborn/qex) ⭐ 60 | 🐛 3 | 🌐 Nim | 📅 2026-09-11 - High-level framework for lattice field operations.
...
* [json-serialization](https://github.com/status-im/nim-json-serialization) ⭐ 54 | 🐛 8 | 🌐 Nim | 📅 2026-09-03 - Flexible JSON serialization not relying on run-time type information.
* [frosty](https://github.com/disruptek/frosty) ⭐ 49 | 🐛 1 | 🌐 Nim | 📅 2021-11-12 - Marshal native Nim objects via streams, sockets.
* [toml-serialization](https://github.com/status-im/nim-toml-serialization) ⭐ 45 | 🐛 4 | 🌐 Nim | 📅 2026-08-24 - Flexible TOML serialization `not` relying on run-time type information.
* [protobuf-serialization](https://github.com/status-im/nim-protobuf-serialization) ⭐ 27 | 🐛 6 | 🌐 Nim | 📅 2026-09-03 - The nim-protobuf-serialization.
...
* [markdown](https://github.com/soasme/nim-markdown) ⭐ 155 | 🐛 18 | 🌐 Nim | 📅 2026-09-03 - A beautiful Markdown Parser in the Nim world.
...
* [nimbus-eth2](https://github.com/status-im/nimbus-eth2) ⭐ 662 | 🐛 223 | 🌐 Nim | 📅 2026-09-11 - Efficient implementation of the Ethereum 2.0 blockchain.
* [nimbus-eth1](https://github.com/status-im/nimbus-eth1) ⭐ 629 | 🐛 118 | 🌐 Nim | 📅 2026-09-11 - An Ethereum 1.0 and 2.0 client for resource-restricted devices.
...
* [niffler](https://github.com/gokr/niffler) ⭐ 2 | 🐛 9 | 🌐 Nim | 📅 2026-09-11 - Command line AI assistant written in Nim.
...
* [Owlkettle](https://github.com/can-lehmann/owlkettle) ⭐ 452 | 🐛 20 | 🌐 Nim | 📅 2026-07-20 - Declarative user interface framework based on GTK.
* [SDL2](https://github.com/nim-lang/sdl2) ⭐ 253 | 🐛 3 | 🌐 Nim | 📅 2026-04-21 - Official wrapper for SDL 2.x.
...
* [libp2p](https://github.com/status-im/nim-libp2p) ⭐ 322 | 🐛 110 | 🌐 Nim | 📅 2026-09-11 - A Nim implementation of the libp2p networking stack.
...
* [json-rpc](https://github.com/status-im/nim-json-rpc) ⭐ 104 | 🐛 11 | 🌐 Nim | 📅 2026-09-07 - Nim library for implementing JSON-RPC clients and servers.
...
* [nwaku](https://github.com/status-im/nwaku) ⭐ 248 | 🐛 250 | 🌐 Nim | 📅 2026-09-11 - Implementation of the Waku v1 and v2 protocols.
...
* [Jazzy](https://github.com/canermastan/jazzy-framework) ⭐ 59 | 🐛 2 | 🌐 Nim | 📅 2026-09-10 - The Productive Framework. Developer-friendly, lightning fast, and designed for rapid development.
* [Supranim](https://github.com/supranim/supranim) ⭐ 41 | 🐛 0 | 🌐 Nim | 📅 2026-09-04 - A simple web framework for creating REST APIs and beautiful web apps. Model View Controller structure and other cool things.
...
* [Tim](https://github.com/openpeeps/tim) ⭐ 68 | 🐛 5 | 🌐 Nim | 📅 2026-09-08 - A high-performance template engine & markup language.
...
* [GLAD](https://github.com/Dav1dde/glad) ⭐ 4,597 | 🐛 32 | 🌐 C | 📅 2026-06-18 - Multi-Language Vulkan/GL/GLES/EGL/GLX/WGL Loader-Generator based on the official specs.
...
* [pararules](https://github.com/paranim/pararules) ⭐ 155 | 🐛 4 | 🌐 Nim | 📅 2023-10-05 - A RETE-based rules engine made for games.
...
* [Editor Support](https://github.com/nim-lang/Nim/wiki/editor-support) ⭐ 18,231 | 🐛 2,189 | 🌐 Nim | 📅 2026-09-11 - Official list of editor plugins for Nim.
...
* [Futhark](https://github.com/PMunch/futhark) ⭐ 504 | 🐛 48 | 🌐 Nim | 📅 2026-09-11 - Automatic wrapping of C headers in Nim with libclang.
...
* [Nimble](https://github.com/nim-lang/nimble) ⭐ 1,401 | 🐛 263 | 🌐 Nim | 📅 2026-09-10 - Nimble can be used as a build system.
...
* [Atlas](https://github.com/nim-lang/atlas) ⭐ 148 | 🐛 10 | 🌐 Nim | 📅 2026-09-11 - The Atlas Package cloner. It manages an isolated workspace that contains projects and dependencies.
...
* [confutils](https://github.com/status-im/nim-confutils) ⭐ 69 | 🐛 16 | 🌐 Nim | 📅 2026-09-03 - Simplified handling of command line options and config files
...
* [Nim for Python programmers](https://github.com/nim-lang/Nim/wiki/Nim-for-Python-Programmers) ⭐ 18,231 | 🐛 2,189 | 🌐 Nim | 📅 2026-09-11 - Guide to Nim for people with experience in Python.
