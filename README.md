...
* [Nim](https://github.com/nim-lang/Nim) ⭐ 18,233 | 🐛 2,195 | 🌐 Nim | 📅 2026-09-15 - Nim (formerly known as "Nimrod") is a compiled, garbage-collected systems programming language which has an excellent productivity/performance ratio. Nim's design focuses on efficiency, expressiveness, elegance (in the order of priority).
* [nlvm](https://github.com/arnetheduck/nlvm) ⭐ 776 | 🐛 13 | 🌐 Nim | 📅 2026-09-14 - LLVM backend for Nim.
...
* [Node.js](https://github.com/juancarlospaco/nodejs) ⭐ 226 | 🐛 0 | 🌐 Nim | 📅 2026-09-07 - Node.js standard library for Nim.
* [cpython](https://github.com/juancarlospaco/cpython) ⭐ 166 | 🐛 0 | 🌐 Python | 📅 2026-09-07 - Python standard library for Nim.

Also, unlike those above, which requires runtime dependancy, some pure-Nim libraries are implemented.

* [pylib](https://github.com/nimpylib/pylib) ⭐ 79 | 🐛 11 | 🌐 Nim | 📅 2026-07-04 - Pure Nim implementation for Python builtins, libraries and sugars.

### Package Repositories

* [Nim packages](https://github.com/nim-lang/packages) ⭐ 500 | 🐛 19 | 🌐 Nim | 📅 2026-09-14 - List of packages for Nimble.
* [Nim package directory](https://nimble.directory/) - Explore Nim packages known to Nimble.

### Editors

* [moe](https://github.com/fox0430/moe) ⭐ 723 | 🐛 45 | 🌐 Nim | 📅 2026-09-14 - A vim-like editor made with Nim, also supports C, Rust, Javascript, etc.
...
* [chronos](https://github.com/status-im/nim-chronos) ⭐ 413 | 🐛 62 | 🌐 Nim | 📅 2026-09-14 - An efficient library for asynchronous programming.
...
* [result](https://github.com/arnetheduck/nim-result/) ⭐ 177 | 🐛 12 | 🌐 Nim | 📅 2026-08-30 - Friendly, exception-free value-or-error returns, similar to Option\[T].
...
* [classes](https://github.com/jjv360/nim-classes) ⭐ 103 | 🐛 2 | 🌐 Nim | 📅 2026-04-13 - Python-style class system for Nim.
...
* [lockfreequeues](https://github.com/elijahr/lockfreequeues) ⭐ 50 | 🐛 3 | 🌐 Nim | 📅 2026-09-15 - Lock-free queue implementations for Nim.
...
* [datetime2human](https://github.com/juancarlospaco/nim-datetime2human) ⭐ 11 | 🐛 0 | 🌐 Nim | 📅 2023-10-12 - Calculate date & time with precision from seconds to millenniums. Human friendly date time as string. ISO-8601.
...
* [node-exporter-lite](https://github.com/twekkel/node_exporter-lite) ⭐ 2 | 🐛 0 | 🌐 Nim | 📅 2026-05-22 - An ultra‑light [node\_exporter](https://github.com/prometheus/node_exporter) ⭐ 13,780 | 🐛 314 | 🌐 Go | 📅 2026-09-03 replacement.
* [unbound-exporter-lite](https://github.com/twekkel/unbound_exporter-lite) ⭐ 1 | 🐛 0 | 🌐 Nim | 📅 2026-05-22 - An ultra‑light [unbound\_exporter](https://github.com/letsencrypt/unbound_exporter) ⭐ 275 | 🐛 19 | 🌐 Go | 📅 2026-06-04 replacement.
...
* [qex](https://github.com/jcosborn/qex) ⭐ 60 | 🐛 3 | 🌐 Nim | 📅 2026-09-15 - High-level framework for lattice field operations.
...
* [KoutenDB](https://github.com/puffball1567/koutendb) ⭐ 16 | 🐛 1 | 🌐 Nim | 📅 2026-09-07 - Locality-aware NoSQL document/vector database built around rings and orbit-inspired retrieval.
...
* [parsetoml](https://github.com/NimParsers/parsetoml) ⭐ 132 | 🐛 11 | 🌐 Nim | 📅 2025-01-12 - A Nim library to parse TOML files.
...
* [Marvdown](https://github.com/openpeeps/marvdown) ⭐ 13 | 🐛 5 | 🌐 Nim | 📅 2026-09-14 - A stupid simple Markdown parser.
...
* [json-serialization](https://github.com/status-im/nim-json-serialization) ⭐ 54 | 🐛 8 | 🌐 Nim | 📅 2026-09-11 - Flexible JSON serialization not relying on run-time type information.
* [frosty](https://github.com/disruptek/frosty) ⭐ 49 | 🐛 1 | 🌐 Nim | 📅 2021-11-12 - Marshal native Nim objects via streams, sockets.
* [toml-serialization](https://github.com/status-im/nim-toml-serialization) ⭐ 45 | 🐛 4 | 🌐 Nim | 📅 2026-09-11 - Flexible TOML serialization `not` relying on run-time type information.
...
* [ssz-serialization](https://github.com/status-im/nim-ssz-serialization) ⭐ 11 | 🐛 5 | 🌐 Nim | 📅 2026-09-15 - Nim implementation of Simple Serialize (SSZ) serialization and merkleization.
...
* [pixie](https://github.com/treeform/pixie) ⭐ 811 | 🐛 15 | 🌐 Nim | 📅 2026-09-13 - A full-featured 2D graphics library for Nim.
...
* [vmath](https://github.com/treeform/vmath) ⭐ 115 | 🐛 2 | 🌐 Nim | 📅 2026-08-07 - Math vector library for graphical things.
...
* [Arraymancer](https://github.com/mratsim/Arraymancer) ⭐ 1,406 | 🐛 165 | 🌐 Nim | 📅 2026-05-26 - A fast, ergonomic and portable tensor library in Nim with a deep learning focus for CPU, GPU, OpenCL and embedded devices.
...
* [bigints](https://github.com/nim-lang/bigints) ⭐ 128 | 🐛 28 | 🌐 Nim | 📅 2026-09-14 - Bigints for Nim.
...
* [constantine](https://github.com/mratsim/constantine) ⭐ 499 | 🐛 96 | 🌐 Nim | 📅 2026-08-04 - Constant time pairing-based of elliptic curve based cryptography and digital signatures.
...
* [nimbus-eth2](https://github.com/status-im/nimbus-eth2) ⭐ 662 | 🐛 222 | 🌐 Nim | 📅 2026-09-15 - Efficient implementation of the Ethereum 2.0 blockchain.
* [nimbus-eth1](https://github.com/status-im/nimbus-eth1) ⭐ 630 | 🐛 112 | 🌐 Nim | 📅 2026-09-15 - An Ethereum 1.0 and 2.0 client for resource-restricted devices.
* [eth](https://github.com/status-im/nim-eth) ⭐ 93 | 🐛 46 | 🌐 Nim | 📅 2026-09-15 - Common utilities for Ethereum.
...
* [snappy](https://github.com/status-im/nim-snappy) ⭐ 28 | 🐛 2 | 🌐 Nim | 📅 2026-09-15 - Nim implementation of Snappy compression algorithm.
...
* [niffler](https://github.com/gokr/niffler) ⭐ 2 | 🐛 18 | 🌐 Nim | 📅 2026-09-15 - Command line AI assistant written in Nim.
...
* [NiGui](https://github.com/trustable-code/NiGui) ⭐ 783 | 🐛 65 | 🌐 Nim | 📅 2026-04-07 - A cross-platform, desktop GUI toolkit.
* [Owlkettle](https://github.com/can-lehmann/owlkettle) ⭐ 453 | 🐛 20 | 🌐 Nim | 📅 2026-09-14 - Declarative user interface framework based on GTK.
...
* [wNim](https://github.com/khchen/wNim) ⭐ 349 | 🐛 35 | 🌐 Nim | 📅 2024-07-19 - Nim's Windows GUI Framework.

#### Linux

* [gintro](https://github.com/StefanSalewski/gintro) ⭐ 300 | 🐛 103 | 🌐 Nim | 📅 2023-05-19 - High-level GObject-Introspection based GTK3/GTK4 bindings for Nim.
...
* [plotly](https://github.com/SciNim/nim-plotly) ⭐ 184 | 🐛 23 | 🌐 Nim | 📅 2024-04-09 - A plotly wrapper for Nim.
...
* [libp2p](https://github.com/status-im/nim-libp2p) ⭐ 322 | 🐛 109 | 🌐 Nim | 📅 2026-09-15 - A Nim implementation of the libp2p networking stack.
...
* [nmqtt](https://github.com/zevv/nmqtt) ⭐ 53 | 🐛 8 | 🌐 Nim | 📅 2026-09-08 - Native Nim MQTT client library.
...
* [quic](https://github.com/status-im/nim-quic) ⚠️ Archived - QUIC for Nim. This is very much a work in progress, and not yet in a usable state.
* [ngtcp2](https://github.com/status-im/nim-ngtcp2) ⚠️ Archived - A wrapper around ngtcp2: an effort to implement IETF QUIC protocol.
...
* [websock](https://github.com/status-im/nim-websock) ⭐ 91 | 🐛 17 | 🌐 Nim | 📅 2026-09-01 - An implementation of the WebSocket protocol for Nim.
...
* [nwaku](https://github.com/status-im/nwaku) ⭐ 248 | 🐛 254 | 🌐 Nim | 📅 2026-09-15 - Implementation of the Waku v1 and v2 protocols.
...
* [Nimquery](https://github.com/GULPF/nimquery) ⭐ 140 | 🐛 0 | 🌐 Nim | 📅 2022-12-06 - Library for querying HTML using CSS selectors, like JavaScript's `document.querySelector`.
...
* [prologue](https://github.com/planety/prologue) ⭐ 1,355 | 🐛 44 | 🌐 Nim | 📅 2026-09-07 - A fullstack web framework written in Nim.
* [karax](https://github.com/karaxnim/karax) ⭐ 1,166 | 🐛 15 | 🌐 Nim | 📅 2026-07-12 - A framework for developing single page applications in Nim.
...
* [Jazzy](https://github.com/canermastan/jazzy-framework) ⭐ 59 | 🐛 2 | 🌐 Nim | 📅 2026-09-12 - The Productive Framework. Developer-friendly, lightning fast, and designed for rapid development.
* [Supranim](https://github.com/supranim/supranim) ⭐ 41 | 🐛 0 | 🌐 Nim | 📅 2026-09-14 - A simple web framework for creating REST APIs and beautiful web apps. Model View Controller structure and other cool things.
...
* [Tim](https://github.com/openpeeps/tim) ⭐ 67 | 🐛 5 | 🌐 Nim | 📅 2026-09-12 - A high-performance template engine & markup language.
...
* [GLAD](https://github.com/Dav1dde/glad) ⭐ 4,604 | 🐛 32 | 🌐 C | 📅 2026-06-18 - Multi-Language Vulkan/GL/GLES/EGL/GLX/WGL Loader-Generator based on the official specs.
...
* [jolt-nim](https://github.com/puffball1567/jolt-nim) ⭐ 5 | 🐛 0 | 🌐 Nim | 📅 2026-09-04 - Native Nim bindings for Jolt Physics 5.6.0 with raw and ownership-safe high-level APIs \[MIT].
...
* [c4](https://github.com/c0ntribut0r/cat-400) ⭐ 92 | 🐛 9 | 🌐 Nim | 📅 2023-12-18 - Modular and extensible 2D and 3D game framework for Nim.
...
* [alasgar](https://github.com/abisxir/alasgar) ⭐ 115 | 🐛 0 | 🌐 Nim | 📅 2026-09-09 - Pure nim 3D game engine based on OpenGL.
...
* [pararules](https://github.com/paranim/pararules) ⭐ 154 | 🐛 4 | 🌐 Nim | 📅 2023-10-05 - A RETE-based rules engine made for games.
...
* [Editor Support](https://github.com/nim-lang/Nim/wiki/editor-support) ⭐ 18,233 | 🐛 2,195 | 🌐 Nim | 📅 2026-09-15 - Official list of editor plugins for Nim.
...
* [INim](https://github.com/AndreiRegiani/INim) ⭐ 684 | 🐛 28 | 🌐 Nim | 📅 2026-02-08 - Interactive Nim Shell.
...
* [Futhark](https://github.com/PMunch/futhark) ⭐ 504 | 🐛 49 | 🌐 Nim | 📅 2026-09-11 - Automatic wrapping of C headers in Nim with libclang.
...
* [Nimble](https://github.com/nim-lang/nimble) ⭐ 1,401 | 🐛 264 | 🌐 Nim | 📅 2026-09-15 - Nimble can be used as a build system.
...
* [Atlas](https://github.com/nim-lang/atlas) ⭐ 148 | 🐛 9 | 🌐 Nim | 📅 2026-09-15 - The Atlas Package cloner. It manages an isolated workspace that contains projects and dependencies.
* [ChooseNim](https://github.com/nim-lang/choosenim) ⭐ 132 | 🐛 28 | 🌐 Nim | 📅 2026-01-09 - Installing and switching between Nim versions (à la rustup, pyenv).
...
* [chronicles](https://github.com/status-im/nim-chronicles) ⭐ 176 | 🐛 17 | 🌐 Nim | 📅 2026-09-11 - A crafty implementation of structured logging for Nim.
...
* [cliche](https://github.com/juancarlospaco/cliche) ⭐ 86 | 🐛 2 | 🌐 Nim | 📅 2026-09-07 - AutoMagic CLI argument parsing is so cliché.
* [confutils](https://github.com/status-im/nim-confutils) ⭐ 69 | 🐛 16 | 🌐 Nim | 📅 2026-09-11 - Simplified handling of command line options and config files
...
* [nimalyzer](https://github.com/thindil/nimalyzer) ⭐ 44 | 🐛 0 | 🌐 Nim | 📅 2026-04-27 - Static code analyzer for Nim, inspired by AdaControl.
...
* [Nim for Python programmers](https://github.com/nim-lang/Nim/wiki/Nim-for-Python-Programmers) ⭐ 18,233 | 🐛 2,195 | 🌐 Nim | 📅 2026-09-15 - Guide to Nim for people with experience in Python.
